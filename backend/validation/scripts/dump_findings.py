...
def main():
    ...
    for i in range(1, 21):
        ...
        perf_score = max(0, min(100, 100.0 - perf_penalty))
        ...
        print(f"  Security Score: {scores['security_score']}, Performance Score: {scores['performance_score']}")
        print(f"  Maintainability Score: {scores['maintainability_score']}")
        print(f"  Performance Impact: {perf_impact:.4f}, Performance Penalty: {perf_penalty:.4f}")
