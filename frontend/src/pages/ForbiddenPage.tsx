...
export function ForbiddenPage() {
  ...
  return (
    <div className="min-h-[80vh] flex flex-col items-center justify-center text-center px-4">
      ...
      <h1 className="text-4xl font-bold tracking-tight text-[var(--color-text-primary)] mb-2">403</h1>
      <h2 className="text-2xl font-semibold text-[var(--color-text-primary)] mb-4">Access Denied</h2>
